# Practice AB-100 with Microsoft Copilot
...
<div class="qz-grid" id="qzGrid">
  <a class="qz-card" data-prompt="You are a Microsoft AB-100 (Agentic AI Business Solutions Architect) certification practice-exam coach. Quiz me one question at a time, exam-style. After I answer, give correctness, the right answer, and a 2-3 line explanation grounded in Microsoft Learn. Cover all AB-100 domains: Plan AI-Powered Business Solutions (discovery, identity, environments, DLP, cost); Design AI-Powered Business Solutions (Copilot Studio Topics, generative answers, knowledge sources, connectors, Power Automate, MCP, multi-agent orchestration, content moderation, M365 Copilot Tuning, adaptive cards); Deploy AI-Powered Business Solutions (channels, ALM, PAC CLI, solutions, managed environments, CoE Starter Kit, Application Insights, KPIs, governance). Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Full exam mode</span><h3>Sequential Practice Exam</h3><p>Exam-style questions across every AB-100 domain.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="Microsoft AB-100 rapid-fire mode: ask 20 short multiple-choice questions, one at a time. After each answer, one-line correctness and the right answer. End with score and 3 weakest topics + Microsoft Learn links. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Speed round</span><h3>Rapid-Fire (20 questions)</h3><p>Twenty short multiple-choice items, score plus weak-topic ranking.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-100 coach. Drill me on Copilot Studio architecture choices: scenarios where I must pick between Topics, Generative answers + knowledge, Connector / Power Automate action, MCP server, or Multi-agent orchestration. Wait for my answer, explain. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Architecture choice</span><h3>Decision-Tree Drills</h3><p>"Which Copilot Studio capability fits?" scenarios.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-100 coach. Drill me on the 50 most common gotchas (e.g. Knowledge sources != fine-tuning; DLP blocks at runtime; Default env is shared so use a dedicated dev env; Premium connectors need premium license; Managed solution in prod; Connection references for per-env credentials). Multiple choice, then explanation. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Trick questions</span><h3>Gotcha and Trap Drill</h3><p>The 50 most-confused exam distinctions.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are an AB-100 coach. Give me a real business scenario; I propose a Copilot Studio architecture (channels, knowledge, actions, identity, DLP, environments, ALM, monitoring). You critique like a Microsoft solutions architect and recommend improvements citing Microsoft Learn. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Architecture critique</span><h3>Architecture Critique</h3><p>You propose an agent design; the coach critiques and grounds in Microsoft Learn.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="I just took the AB-100 practice exam. First ask which 2 domains I want to drill (Plan / Design / Deploy). Then 10 deeper scenario questions on those domains with Microsoft Learn references. Begin by asking which domains." data-target="copilot" href="#"><span class="qz-eyebrow">Targeted study</span><h3>Weak-Area Deep Dive</h3><p>Tell Copilot which two domains you struggle with.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
</div>

<div class="qz-alt">
  <button data-prompt="You are a Microsoft AB-100 (Agentic AI Business Solutions Architect) practice-exam coach. Quiz me one question at a time, exam-style. Cover Plan / Design / Deploy. Begin." data-target="gemini">Open same prompt in Google Gemini</button>
  <button data-prompt="You are a Microsoft AB-100 (Agentic AI Business Solutions Architect) practice-exam coach. Quiz me one question at a time, exam-style. Cover Plan / Design / Deploy. Begin." data-target="chatgpt">Open same prompt in ChatGPT</button>
  <button data-prompt="You are a Microsoft AB-100 (Agentic AI Business Solutions Architect) practice-exam coach. Quiz me one question at a time, exam-style. Cover Plan / Design / Deploy. Begin." data-target="claude">Open same prompt in Claude</button>
</div>
...
> [!IMPORTANT]
> [Microsoft Learn](https://learn.microsoft.com) is the authoritative source for AB-100 content.
